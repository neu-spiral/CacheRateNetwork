...
if __name__ == "__main__":
    ...
    ax[0].plot(iterations, lagrangians, label='L', linewidth=3)
    ax[0].plot(iterations, objs, label='Obj', linewidth=3)
    ...
    ax[1].plot(iterations, violations, label='SumOverflow', linewidth=3)
    ax[1].plot(iterations, violations_max, label='MaxOverflow', linewidth=3)
